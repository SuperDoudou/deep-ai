...
interface InputAreaProps {
    onSendMessage: (message: string, contextAreaInfo: ContextAreaInfo, promptTemplate: string) => void
...
function InputArea({ onSendMessage, onStopSendingMessage, sendingMessage }: InputAreaProps) {
    ...
    const promptConfigModalRef = useRef<typeof PromptConfigModal>(null);
    ...
    const handleInputSend = (e: any) => {
        ...
        onSendMessage(inputMessage, contextAreaInfo, promptTemplate);
    };
        ...
        <div id="chat_input_part">
            ...
            <div id="chat_input_area_action">
                ...
                <div id="chat_input_area_action_right">
                    {promptEditor && (
                        <PromptConfigModal ref={promptConfigModalRef}
                            onClose={() => setPromptEditor(false)}></PromptConfigModal>
                    )}
